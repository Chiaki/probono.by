        ...
        <div class="container pt90 pb50" id="about">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 mb40 text-center">
                    Мы собираем информацию о любых открытых инициативах, группах, центрах помощи пострадавшим. Наша задача связать пострадавшего с людьми, которые готовы ему помочь. Наши инструменты: этот портал и волонтерский колл-центр.
                </div>
            </div>
            <div class="row">
